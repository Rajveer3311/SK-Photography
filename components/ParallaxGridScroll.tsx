...
export default function ParallaxGridScroll({
  title = "Parallax Grid Scroll",
  subtitle = "Parallax Grid Scroll",
  ...
  return (
    <section
      ref={sectionRef}
      className="relative overflow-hidden bg-white/95 text-white px-4 py-16 sm:px-6 lg:px-8"
    >
      <div className="mx-auto max-w-7xl">
        <div className=" text-center">
          <h1 className=" text-4xl font-light text-black sm:text-5xl">
            {title}
          </h1>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          >
            {leftColumn.map((src, index) => (
              <div
                key={`left-${index}`}
                className="overflow-hidden rounded-[1.25rem] border border-white/10 bg-white/5 shadow-[0_40px_120px_-60px_rgba(0,0,0,0.5)]"
              >
                <img
                  src={src}
